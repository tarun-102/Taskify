      ...
      <div className="max-w-1200 mx-auto" style={{ maxWidth: "1200px" }}>
        ...
        {activeTab === "tasks" && (
          <div className="bg-white rounded-4 shadow-sm border border-light-subtle">
            <div className="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center p-4 gap-3 border-bottom">
              ...
              <button onClick={() => { setTaskModalType("add"); }} className="btn btn-primary rounded-pill px-4 py-2 shadow-sm d-flex align-items-center gap-2 fw-semibold" style={{ backgroundColor: "#5850EC", border: "none" }}><FiPlus size={18} /> Add Task</button>
            </div>
        ...
        {activeTab === "members" && (
          <div className="bg-white rounded-4 shadow-sm border border-light-subtle p-4">
            <div className="d-flex justify-content-between align-items-center mb-4">
              ...
              <button onClick={() => { setMemberModalType("add"); }} className="btn btn-primary rounded-pill px-4 py-2 shadow-sm d-flex align-items-center gap-2 fw-semibold" style={{ backgroundColor: "#5850EC", border: "none" }}><FiPlus size={18} /> Add Member</button>
            </div>
